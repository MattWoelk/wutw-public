...
func _enter_tree() -> void:
	...
	control.size.x = 1920
	control.size.y = 450
	GlobalUI.add_layer_content(control, UI.Layer.DEV_CONSOLE)
	...
	rich_label.append_text("[color=red]WARNING: Using console commands will disable Steam achievements on this savegame.[/color]\n")
